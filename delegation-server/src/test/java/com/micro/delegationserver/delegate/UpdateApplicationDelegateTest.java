...
class UpdateApplicationDelegateTest {
    ...
    @Test
    void execute() {
        updateApplicationDelegate.execute(delegateExecution);
        verify(mongoTemplate).save(Mockito.any(Delegation.class),Mockito.anyString());
    }
}