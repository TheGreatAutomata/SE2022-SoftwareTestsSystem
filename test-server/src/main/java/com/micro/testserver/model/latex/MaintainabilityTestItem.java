...
public class MaintainabilityTestItem {

    private String testFeature;
    private String testDescription;
    private String testResult;

    public MaintainabilityTestItem() {
    }

    public MaintainabilityTestItem(String testFeature, String testDescription, String testResult) {
